        ...
        <div className="flex flex-1 h-full flex-wrap flex-row items-center z-40 bg-white transition-all duration-500" id="header">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto sm:hidden md:block md:mr-auto flex flex-wrap flex-col sm:flex-col md:flex-row items-center text-base justify-center md:space-x-20 transition-all duration-500" id="nav">
                    <a href="#about" className="mr-5 mb-5 md:mb-0 hover:text-gray-900">About</a>
                    <a href="#about" className="mr-5 mb-5 md:mb-0 hover:text-gray-900">Skills</a>
                    <a href="#about" className="mr-5 mb-5 md:mb-0 hover:text-gray-900">Contact</a>
                </nav>
                <div className="inline-flex sm:hidden md:block items-center border-0 rounded text-base mt-4 md:mt-0 transition-all duration-500" id="talk">
                    <span className="mr-2">Got an idea</span><button className="py-2 px-4 rounded-md bg-yellow-400 focus:outline-none font-bold hover:bg-yellow-500">Let's Talk!</button>
                </div>
            </div>
        </div>
    )
