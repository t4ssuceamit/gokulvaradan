    ...
    className="flex flex-col justify-center items-center">
        ...
        <div class="w-9/12 px-5 py-16 mx-auto flex flex-wrap z-0 flex-col">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 class="font-bold title-font text-gray-900 mb-1 text-xl">Languages</h2>
                <p class="leading-relaxed">Expertized in Python, JavaScript, Golang</p>
                </div>
            </div>
            </div>
            <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 class="font-bold title-font text-gray-900 mb-1 text-xl">Ethical Hacker</h2>
                <p class="leading-relaxed">Completed CEHv10 Certification</p>
                </div>
            </div>
            </div>
            </div>
